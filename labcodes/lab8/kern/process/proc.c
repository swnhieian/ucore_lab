...
alloc_proc(void) {
     ...
     */
    //LAB8:EXERCISE2 2012011367 HINT:need add some code to init fs in proc_struct, ...
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2012011367
    //LAB8:EXERCISE2 2012011367  HINT:how to copy the fs in parent's proc_struct?
    /*
